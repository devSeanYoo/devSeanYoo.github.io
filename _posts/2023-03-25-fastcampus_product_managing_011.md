...
- **서비스 알고리즘 설계**  
  앱 실행부터 기능 활용까지  
  > ex. 화면에서 제공되는 데이터, 인풋 데이터, 특정 DB 연결, 등 프로세스 맵화

<br>

- **와이어프레임 설계 및 프로토타입 디자인, 화면설계서 작성**  
  - 피그마를 사용하지만 MacOS 위주의 서비스라 한계 존재
    - 커뮤니티에서 참고할 템플릿을 이용할 수 있음
    - 타겟 서비스의 톤앤매너를 고려해서 UI 디자인
  - 기획자는 기본적으로 슬라이드를 통한 화면설계서
    - 각 UI마다 설명 추가
    > ex. 어떤 경우에 UI 노출, UI내에 어떤 데이터 불러오기, 어떤 수식으로 데이터 계산해서 표현하는지

<br>

- **요구사항정의서**  
  - 기능, UI디자인, DB, 등 구분하고 상세내용 및 반영되어야 할 화면 작성
- **WBS**
  - 프로젝트 명과 각 프로젝트 시작 및 종료일 계획 및 시각화

- **기대효과 정리**  
  - 개선의 목적, 컨셉, 개선 기능, 개선 효과를 한 장으로 정리해서 시각화

<br>

- 추가적으로 피드백을 받기 위해 만든 개선방안을 다른 사람들에게 공유
